...
public class JedissonJsr107CacheConfiguration<K,V> implements CompleteConfiguration<K,V>{
	...
	public JedissonJsr107CacheConfiguration(){
		
	}
	
	public JedissonJsr107CacheConfiguration(final String name, final CompleteConfiguration<K,V> configuration){
		this.name = name;
	...
	public JedissonJsr107CacheConfiguration(final String name, final Configuration<K,V> configuration){
		this.name = name;
		keyType = configuration.getKeyType();
		valueType = configuration.getValueType();
		isStoreByValue = configuration.isStoreByValue();
